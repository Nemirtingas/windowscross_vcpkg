...
RUN cd / &&\
    ...
    cd /clang_windows_sdk/msvc && gdown.pl 'https://drive.google.com/file/d/1mJxny3IsxZlI_BSFC_1BMWcZ7jpVmQci/view?usp=sharing' "${MSVC_VER}.tgz"; tar xf "${MSVC_VER}.tgz" && rm -f "${MSVC_VER}.tgz" gdown* &&\
    cd /clang_windows_sdk/winsdk && gdown.pl 'https://drive.google.com/file/d/1O1GmbPIyKyzdfMb3HqGW6aP1pOAtrrc-/view?usp=sharing' "winsdk_${WINSDK_VER}.tgz"; tar xf "winsdk_${WINSDK_VER}.tgz" && rm -f "winsdk_${WINSDK_VER}.tgz" gdown* &&\
